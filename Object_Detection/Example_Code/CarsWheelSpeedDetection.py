...
while (cap.isOpened()):
    ...
    if ret:
        ...
        for x in w:
            ...
            if (tire == 0):
                cv2.putText(img, str(2 * (car) - wno), (x[0], x[1] - 100), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255, 0, 0),
                            thickness=3)
                ...
                cv2.putText(img, str(speed) + "pixels/frame", (x[0], x[1] + 100), cv2.FONT_HERSHEY_SIMPLEX, 0.85,
                            (0, 255, 0), thickness=1)
                wno -= 1
            if (tire == 1 and t == 2):
                cv2.putText(img, str(2 * (car) - wno), (x[0], x[1] - 100), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255, 0, 0),
                ...
                wno -= 1
            if (tire == 1 and t == 1):
                cv2.putText(img, str(2 * (car)), (x[0], x[1] - 100), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255, 0, 0),
                            thickness=3)
                label.append((2 * (car)))
                temp = [((x[0], x[1]), frame_count)]
